...
export class ContactService {
  ...
  //mock the server
  private _contactsDb = CONTACTS as Contact[];

  private _contacts$ = new BehaviorSubject<Contact[]>([])
  public contacts$ = this._contacts$.asObservable()
  private filterBy: Filter = { term: '' }
  ...
  public getContactById(id: string): Observable<Contact> {
    ...
    return contact ? of(contact) : of(new Contact('', '', '', ''))
  }
  ...
  private _addContact(contact: Contact) {
    //mock the server work
    const newContact = new Contact(this.utilService.makeId(), contact.name, contact.email, contact.phone);
